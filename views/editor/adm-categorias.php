...
<div class="alertaMensaje show-alert " id="ban">

    <div class="content-icon alert-success">
...
if (!empty($categorias)) {
    ...
    foreach ($categorias as $categoria) { ?>
        ...
        <div class="table">
            ...
            <!-- botones de la tabla -->
            <div class="btn-actions">
                <div class="btn-modificar btn-mod-updCategoria" data-id="<?php echo $categoria["id_categoria"]; ?>">
                    Editar
                </div>

                <div class="modal-background" id="item-bg-updCategoria-<?php echo $categoria["id_categoria"]; ?>">
                </div>

                <!-- contenido del modal -->
                <div class="modal-content" id="item-cont-updCategoria-<?php echo $categoria["id_categoria"]; ?>">
                    ...
                    <form class="from" method="POST" action="">
                        <fieldset>
                            ...
                            <label class="block h3-2" for="">
                                NOMBRE*
                                <input class="block p-t-5 input-text" type="text" name="nombre_categoria" value="<?php echo $categoria["nombre_categoria"]; ?>" placeholder="">
                            </label>
                            ...
                            <!-- button -->
                            <input class="btn-submit m-t-18 m-b-8" type="submit" value="MODIFICAR" readonly>
                ...
                <div class="btn-eliminar-full btn-mod-delCategoria m-izq-10" data-id="<?php echo $categoria["id_categoria"]; ?>">
                    <?php
                    if ($categoria["estado_categoria"] === '1') {
                        echo 'Desactivar';
                    } else {
                ...
                <div class="modal-background" id="item-bg-delCategoria-<?php echo $categoria["id_categoria"]; ?>">
                </div>

                <!-- contenido del modal -->
                <div class="modal-content" id="item-cont-delCategoria-<?php echo $categoria["id_categoria"]; ?>">
                    ...
                    <form class="from" method="POST" action="">
                        <fieldset>
                            ...
                            <div class="botones-modal">
                                <input class="btn-modificar" type="submit" value="Si" readonly>

                                <div class="btn-eliminar" id="item-close-delCategoria-<?php echo $categoria["id_categoria"]; ?>">
                                    No
                                </div>
                            </div>
                        </fieldset>
